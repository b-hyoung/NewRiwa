# Generated by Django 4.0.4 on 2022-04-25 18:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mostpick', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mostpick', to='api.mostpick')),
            ],
        ),
        migrations.CreateModel(
            name='ER_Game_Record',
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('items', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.itemmodels')),
            ],
        ),
    ]
